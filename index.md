...
Conventional prosthetics electromyography (EMG) to sense muscle activation on an amputee's residual muscles. My MS Thesis develops the second iteration of the project outlined above. I use Deep Learning directly on raw ultrasound pulses to output continuous regressions. This approach skips the traditional imaging step and enables the system to be miniaturized substantially by custom designing the ultrasound transducer array. My thesis is advised by Gil Weinberg (Georgia Tech), Byron Boots (Google Brain) and Mason Bretan (Futurewei Inc.)
